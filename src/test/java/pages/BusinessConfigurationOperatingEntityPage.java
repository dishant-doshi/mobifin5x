...
public class BusinessConfigurationOperatingEntityPage extends SetupInit {
	...
	By btnOk = By.xpath("//*[normalize-space(text()) = '" + ScriptConstants.REGIONALENTITY_OK + "']//parent::button");
	By btnSave = By.xpath("//*[normalize-space(text())='" + ScriptConstants.BUSINESSZONE_SAVE + "']//parent::button");
