...
public interface PlatformConfigurationParameter {
	...
	By txtPossibleValueInEdit = By.id(Utility.readJSFile("INPUT_PARAMETER_EDIT_POSSIBLEVALUE", CommonConstants.ELEMENT_FILE));
	By drpDataType = By.xpath("//*[@id='" + Utility.readJSFile("INPUT_PARAMETER_ADD_DATATYPE", CommonConstants.ELEMENT_FILE)
	...
	By drpFieldName = By
			.xpath("(//*[contains(@id,'" + Utility.readJSFile("INPUT_PARAMETER_ADD_CHILDFIELD", CommonConstants.ELEMENT_FILE)
	...
	By txtDescriptionInEdit = By.id(Utility.readJSFile("INPUT_PARAMETER_EDIT_DESCRIPTION", CommonConstants.ELEMENT_FILE));
